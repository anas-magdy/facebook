...
const watch = () => {
    ...
    return (
        <Grid container>
            <Grid size={3} sx={{ display: { xs: "none",md:"grid" }}}>
                <p>anaaaaas</p>
            </Grid>
            <Grid size={{xs:12, md:9}} sx={{ display: { xs: "grid" },  padding: "15px",
                    height: "100vh",
            ...
            >
                {
                    videos.map((video, index) => {
                        ...
                        return (
                            ...
                            <Box sx={{ width: { xs: "100%", md: "90%" }, margin: "5px", borderRadius: "15px", padding: "10px" }} flexDirection={"column"} bgcolor={"#242526"} key={index}>
